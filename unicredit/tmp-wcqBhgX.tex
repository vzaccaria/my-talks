...
\label{sec:org521fe77}
\section{Contract languages}
\label{sec:org158fe45}
\begin{frame}[fragile,label={sec:org0f04244}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org2bcb039}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org4a3d395}
\begin{frame}[label={sec:orgdc7d063}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orge3e9e19}]{Certified symbolic management}
...
\label{sec:orged28f7c}
\section{Type systems}
\label{sec:org5d8e209}
\begin{frame}[label={sec:org04007ce}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org5de9c05}]{Certified symbolic management}
...
\begin{frame}[label={sec:org0a495d5}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org31e490f}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:org389ca37}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org502990f}
\begin{frame}[label={sec:org0778f90}]{Papers}
