...
\label{sec:org6017ef2}
\section{Contract languages}
\label{sec:orgda60fee}
\begin{frame}[fragile,label={sec:org8cefd2a}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org5aa3bf4}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgbb8562c}
\begin{frame}[label={sec:orgc92963a}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgf5d97c3}]{Certified symbolic management}
...
\label{sec:org1ad6710}
\section{Type systems}
\label{sec:orgf020b66}
\begin{frame}[label={sec:org26d3aff}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org867cb2f}]{Certified symbolic management}
...
\begin{frame}[label={sec:org48ab83b}]{Temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org510bde6}
\begin{frame}[label={sec:orgd6cf373}]{Papers}
