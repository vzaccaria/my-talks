...
\label{sec:org6d01eb7}
\section{Contract languages}
\label{sec:orga2ab3f5}
\begin{frame}[fragile,label={sec:org87bbad8}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orge4fe4c4}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgeda6c77}
\begin{frame}[label={sec:org65fd33b}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org42e6194}]{Certified symbolic management}
...
\label{sec:org9208949}
\section{Type systems}
\label{sec:orgb58149b}
\begin{frame}[label={sec:org6553d2d}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org85ae7d0}]{Certified symbolic management}
...
\begin{frame}[label={sec:org84ae5c7}]{Functional Reactive programs}
...
\begin{frame}[label={sec:orgfe08a90}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:org419bb59}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org9a786e0}
\begin{frame}[label={sec:orga06f128}]{Papers}
