...
\label{sec:org7db7b7b}
\section{Contract languages}
\label{sec:org393044e}
\begin{frame}[fragile,label={sec:org9a058ab}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org7688b36}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
...
\begin{frame}[label={sec:org0e2f39c}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgc35d974}]{Certified symbolic management}
...
\label{sec:org3eae108}
\section{Type systems}
\label{sec:org840e8e6}
\begin{frame}[label={sec:org67b7fc7}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orga07bbff}]{Certified symbolic management}
...
\section{References}
\label{sec:orgad7fe71}
\begin{frame}[label={sec:org6043f46}]{Papers}
