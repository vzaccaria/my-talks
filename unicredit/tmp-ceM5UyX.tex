...
\label{sec:org4ef87b1}
\section{Contract languages}
\label{sec:orgc83c6e3}
\begin{frame}[fragile,label={sec:org8edfee0}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\section{Semantics}
\label{sec:org4c20202}
\begin{frame}[label={sec:orgb63f848}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orga7fb443}]{Certified symbolic management}
...
\label{sec:org10153e6}
\section{Type systems}
\label{sec:org27cf775}
\begin{frame}[label={sec:org8557524}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org28b045b}]{Certified symbolic management}
...
\section{References}
\label{sec:org3b9168c}
\begin{frame}[label={sec:org0c060db}]{Papers}
