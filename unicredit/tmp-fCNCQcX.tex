...
\label{sec:org1d62fd9}
\section{Contract languages}
\label{sec:org2d0aee1}
\begin{frame}[fragile,label={sec:org9044755}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orge0e1204}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org678cfc9}
\begin{frame}[label={sec:orga71d556}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org6027c9a}]{Certified symbolic management}
...
\label{sec:orgc7e58d7}
\section{Type systems}
\label{sec:orgca28b0a}
\begin{frame}[label={sec:org38dfd2d}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org6e7a2ca}]{Certified symbolic management}
...
\begin{frame}[label={sec:orga5ba846}]{Functional Reactive programs}
...
\begin{frame}[label={sec:orgf5f1c97}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:org48210a8}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org6a852c8}
\begin{frame}[label={sec:org8156773}]{Papers}
