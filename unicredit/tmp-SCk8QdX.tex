...
\label{sec:orgdf49753}
\section{Contract languages}
\label{sec:orgecf5b79}
\begin{frame}[fragile,label={sec:org536dfef}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org12fe801}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org69ddd7f}
\begin{frame}[label={sec:org3459680}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgf0ddd66}]{Certified symbolic management}
...
\label{sec:orga3cef7b}
\section{Type systems}
\label{sec:org7a79926}
\begin{frame}[label={sec:org7bb18ee}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orgfcb9318}]{Certified symbolic management}
...
\begin{frame}[label={sec:org64cd2ec}]{Temporal logic cite:Davies:2017gk}
\begin{itemize}
\item Temporal logic is an extension of logic to include proofs that formulas are
valid at particular times.

\item Inference rules are indexed and there is a new operator \(\bigcirc A\) which stands for
the value of \(A\) at the ``next'' (discrete) time:
$$\inference[E]{\Gamma |-^{(n)} A \rightarrow B & \Gamma |-^{(n)} A}{\Gamma |-^{(n)} B}$$ or,
$$\inference[\bigcirc E]{\Gamma |-^{(n)} \bigcirc A}{\Gamma |-^{(n+1)} A}$$
\end{itemize}
\end{frame}
...
\section{References}
\label{sec:orgb01b8ca}
\begin{frame}[label={sec:org49f891d}]{Papers}
