...
\label{sec:orgbd52f28}
\section{Contract languages}
\label{sec:org68c91fc}
\begin{frame}[fragile,label={sec:org073b9a6}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbb096a5}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgb3908f7}
\begin{frame}[label={sec:org2875c66}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org53633cf}]{Certified symbolic management}
...
\label{sec:org83b800b}
\section{Type systems}
\label{sec:org17b6aba}
\begin{frame}[label={sec:org3e5c51a}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orgeead13b}]{Certified symbolic management}
...
\begin{frame}[label={sec:org1125ec8}]{Temporal logic cite:Davies:2017gk}
\begin{itemize}
...
\section{References}
\label{sec:org17da97a}
\begin{frame}[label={sec:orgcd379be}]{Papers}
