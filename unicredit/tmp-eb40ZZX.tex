...
\label{sec:orgb2f28ad}
\section{Contract languages}
\label{sec:org6f262d0}
\begin{frame}[fragile,label={sec:orgb9a8bfc}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org7983f54}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgd1f1eb1}
\begin{frame}[label={sec:orgcc3d03c}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgbb3e870}]{Certified symbolic management}
...
\label{sec:org4643adc}
\section{Type systems}
\label{sec:org76d37d9}
\begin{frame}[label={sec:org8b1d0fb}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orga76ee66}]{Certified symbolic management}
...
\begin{frame}[label={sec:orgc83a4d2}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org84e4d17}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:org66d8a8e}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgff3cede}
\begin{frame}[label={sec:org471999e}]{Papers}
