...
\label{sec:org456cded}
\section{Contract languages}
\label{sec:orgbc3ef9f}
\begin{frame}[fragile,label={sec:org8b1577d}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org9d51f77}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org358dcaf}
\begin{frame}[label={sec:org8dc0da1}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgcd9818b}]{Certified symbolic management}
...
\label{sec:orge06f0fc}
\section{Type systems}
\label{sec:org6edfd43}
\begin{frame}[label={sec:org585060d}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org1abe5fc}]{Certified symbolic management}
...
\begin{frame}[label={sec:org02a2246}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org0444f6f}]{Functional reactive programs}
\begin{itemize}
...
Types are \alert{indexed} over time: \(RSet = Time \rightarrow Set, RSet \in \univ{1}\)
\end{itemize}
...
\begin{frame}[label={sec:org3e3929b}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org2812d28}
\begin{frame}[label={sec:orgd2f03f6}]{Papers}
