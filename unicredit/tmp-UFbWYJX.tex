...
\label{sec:orgd0f9c5a}
\section{Contract languages}
\label{sec:orgce8c9d1}
\begin{frame}[fragile,label={sec:org1c60400}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org3a47f60}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org1904491}
\begin{frame}[label={sec:org03a3134}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgc456c9f}]{Certified symbolic management}
...
\label{sec:org832c41e}
\section{Type systems}
\label{sec:org0d8341a}
\begin{frame}[label={sec:org3fd293c}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org932a4df}]{Certified symbolic management}
...
\begin{frame}[label={sec:orga027c13}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org9165737}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgfe2bd6d}
\begin{frame}[label={sec:org2d5b1ab}]{Papers}
