...
\label{sec:org57acfdf}
\section{Contract languages}
\label{sec:org0976d2c}
\begin{frame}[fragile,label={sec:orgd95edd4}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org107cac1}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgd9d9562}
\begin{frame}[label={sec:org8768058}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgd44b4ff}]{Certified symbolic management}
...
\label{sec:org2f6f0fc}
\section{Type systems}
\label{sec:orgfecb7f6}
\begin{frame}[label={sec:orgea9ee4a}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orge054bf8}]{Certified symbolic management}
...
\begin{frame}[label={sec:org2b46273}]{Temporal logic cite:Davies:2017gk}
\begin{itemize}
...
$$\inference{\Gamma |-^{(n)} A \rightarrow B & \Gamma |-^{(n)} A}{\Gamma |-^{(n)} B}$$
\end{itemize}
\end{frame}
...
\section{References}
\label{sec:orga225651}
\begin{frame}[label={sec:orgd969d09}]{Papers}
