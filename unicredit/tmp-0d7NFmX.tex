...
\label{sec:org405e779}
\section{Contract languages}
\label{sec:org4abc903}
\begin{frame}[fragile,label={sec:orgf6db29e}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org1e303fd}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org6553f06}
\begin{frame}[label={sec:org91714aa}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgfde0a3d}]{Certified symbolic management}
...
\label{sec:orgcf1dce6}
\section{Type systems}
\label{sec:orgde2d6a0}
\begin{frame}[label={sec:orgfbcf652}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org3d1fb57}]{Certified symbolic management}
...
\begin{frame}[label={sec:orgce686f7}]{Temporal logic cite:Davies:2017gk}
\begin{itemize}
...
$$\inference[E]{\Gamma |-^{(n)} A \rightarrow B & \Gamma |-^{(n)} A}{\Gamma |-^{(n)} B}$$
\end{itemize}
\end{frame}
...
\section{References}
\label{sec:orgee63cdf}
\begin{frame}[label={sec:orgfdb7080}]{Papers}
