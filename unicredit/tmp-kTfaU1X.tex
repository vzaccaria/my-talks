...
\label{sec:org779a835}
\section{Contract languages}
\label{sec:orge1b2163}
\begin{frame}[fragile,label={sec:orgecc206a}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org2053a92}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org42bfb30}
\begin{frame}[label={sec:org0c8efb1}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org201f3aa}]{Certified symbolic management}
...
\label{sec:org70e9ac4}
\section{Type systems}
\label{sec:org903c1ca}
\begin{frame}[label={sec:org6f7a9b8}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org4f9f6ac}]{Certified symbolic management}
...
\begin{frame}[label={sec:org5923184}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org6d0ecc2}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:org7f66da5}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org5d64445}
\begin{frame}[label={sec:org3f41c11}]{Papers}
