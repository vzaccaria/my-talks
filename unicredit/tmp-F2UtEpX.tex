...
\label{sec:org3dbfbf8}
\section{Contract languages}
\label{sec:org7f62a2e}
\begin{frame}[fragile,label={sec:orgd776828}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org78875e3}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org62a4599}
\begin{frame}[label={sec:org4c36da5}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org175768c}]{Certified symbolic management}
...
\label{sec:org9a17ac0}
\section{Type systems}
\label{sec:org92b5117}
\begin{frame}[label={sec:orgc5604c3}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orga4b4b96}]{Certified symbolic management}
...
\begin{frame}[label={sec:orga77aff8}]{Functional Reactive programs}
...
\begin{frame}[label={sec:orga312030}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgd7737ce}
\begin{frame}[label={sec:orgad6bd4e}]{Papers}
