...
\label{sec:orgbc6dba5}
\section{Contract languages}
\label{sec:orga08e27c}
\begin{frame}[fragile,label={sec:orgb2535e9}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org7669347}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org43611b1}
\begin{frame}[label={sec:org5de07c6}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgff96d0b}]{Certified symbolic management}
...
\label{sec:org9738657}
\section{Type systems}
\label{sec:org8a722ad}
\begin{frame}[label={sec:org378c9b3}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org6ebba81}]{Certified symbolic management}
...
\begin{frame}[label={sec:orgf8d7648}]{Functional Reactive programs}
...
Linear-time Temporal Logic (LTL) cite:Jeffrey:2012fh is a natural extension of the type system for
FRP, which constrains the temporal behaviour of reactive programs.
...
\begin{frame}[label={sec:org2f86727}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgd4f3f58}
\begin{frame}[label={sec:orgbdcf22d}]{Papers}
