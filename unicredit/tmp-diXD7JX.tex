...
\label{sec:orge49a32f}
\section{Contract languages}
\label{sec:orge0eda93}
\begin{frame}[fragile,label={sec:org87bbe45}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb7177dd}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org06b22e3}
\begin{frame}[label={sec:orgf907555}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org1a0aa86}]{Certified symbolic management}
...
\label{sec:org9b5e5c8}
\section{Type systems}
\label{sec:org4c6b5a3}
\begin{frame}[label={sec:org77ef2c7}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org930409a}]{Certified symbolic management}
...
\begin{frame}[label={sec:org9db8589}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org50dd39e}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:orge858d00}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgfb4a455}
\begin{frame}[label={sec:org9899b62}]{Papers}
