...
\label{sec:org8fc07b6}
\section{Contract languages}
\label{sec:org62c41d5}
\begin{frame}[fragile,label={sec:org1d93424}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org2368a24}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgef82369}
\begin{frame}[label={sec:org151faed}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org340f6f8}]{Certified symbolic management}
...
\label{sec:orgf1863c1}
\section{Type systems}
\label{sec:orgfb4d660}
\begin{frame}[label={sec:org1d7bbba}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orge6843f4}]{Certified symbolic management}
...
\begin{frame}[label={sec:org44e76dc}]{Functional Reactive programs}
...
\begin{frame}[label={sec:orgaa007a1}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgc85db16}
\begin{frame}[label={sec:org19ed05f}]{Papers}
