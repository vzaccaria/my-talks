...
\label{sec:org3a50c99}
\section{Contract languages}
\label{sec:orgc85c891}
\begin{frame}[fragile,label={sec:orgf35979a}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org61a16de}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org9dbe8d4}
\begin{frame}[label={sec:org18aeb5a}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgf2f679c}]{Certified symbolic management}
