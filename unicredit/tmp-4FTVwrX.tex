...
\label{sec:orgd55f8bd}
\section{Contract languages}
\label{sec:org276ef44}
\begin{frame}[fragile,label={sec:org9e62257}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb39b378}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times; syntax similar to others

\item Not intuitive reference to parties involved
...
\section{Semantics}
\label{sec:org111de0e}
\begin{frame}[label={sec:org9f3c6df}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org2e49a00}]{Certified symbolic management}
...
\label{sec:orge742a9e}
\section{Type systems}
\label{sec:orgdb427f7}
\begin{frame}[label={sec:orgb4e8563}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org73878f7}]{Certified symbolic management}
...
\section{References}
\label{sec:org25424af}
\begin{frame}[label={sec:orgffa5799}]{Papers}
