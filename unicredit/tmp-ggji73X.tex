...
\label{sec:org17e4df1}
\section{Contract languages}
\label{sec:org798d79e}
\begin{frame}[fragile,label={sec:orgd862bbb}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbc4e0c8}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org377cbdd}
\begin{frame}[label={sec:org2047119}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org50e4743}]{Certified symbolic management}
...
\label{sec:orgf95087d}
\section{Type systems}
\label{sec:orgc6c0e68}
\begin{frame}[label={sec:orga5e7c54}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orgdb91a74}]{Certified symbolic management}
...
\begin{frame}[label={sec:org3c00f56}]{Functional Reactive programs}
...
\begin{frame}[label={sec:orgf6d31ed}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:orgdfc22fb}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org51fe198}
\begin{frame}[label={sec:orgf494182}]{Papers}
