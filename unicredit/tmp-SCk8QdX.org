...
** Temporal logic cite:Davies:2017gk

- Temporal logic is an extension of logic to include proofs that formulas are
  valid at particular times.

- Inference rules are indexed and there is a new operator $\bigcirc A$ which stands for
