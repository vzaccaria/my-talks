...
\label{sec:org99770b1}
\section{Contract languages}
\label{sec:orgd1298f9}
\begin{frame}[fragile,label={sec:org0596d0e}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgbddab48}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgaa4b58d}
\begin{frame}[label={sec:org2b00ff9}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgf091dad}]{Certified symbolic management}
