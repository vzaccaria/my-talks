...
\label{sec:org1261a04}
\section{Contract languages}
\label{sec:org9874241}
\begin{frame}[fragile,label={sec:org2f24bf2}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgac22270}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org65193fa}
\begin{frame}[label={sec:orgf88f728}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org6470698}]{Certified symbolic management}
...
\label{sec:orged98e97}
\section{Type systems}
\label{sec:org08cdb09}
\begin{frame}[label={sec:orga492062}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org8cc2fbd}]{Certified symbolic management}
...
\begin{frame}[label={sec:orgf8ddde7}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org36ef094}]{Functional reactive programs}
\begin{itemize}
...
Types are \alert{indexed} over time: \(RSet = Time \rightarrow Set\)
\end{itemize}


\begin{itemize}
\item Types can be constant over time, but also change dynamically. For example,
past is a dependent function:

$$Past = \lambda (t: Time). \sum_{s: Time} (s \leq t)$$
\end{itemize}
\end{frame}



\begin{frame}[label={sec:org46f1ca4}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org869a3d9}
\begin{frame}[label={sec:org24a2226}]{Papers}
