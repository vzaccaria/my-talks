...
\label{sec:orgf51df27}
\section{Contract languages}
\label{sec:orgb7fd2e0}
\begin{frame}[fragile,label={sec:org3bd63f1}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org8830994}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgbb567ca}
\begin{frame}[label={sec:org390b39b}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org9c25810}]{Certified symbolic management}
...
\label{sec:orgac31e3d}
\section{Type systems}
\label{sec:orgc393e7e}
\begin{frame}[label={sec:org6e655ce}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orga91c268}]{Certified symbolic management}
...
\begin{frame}[label={sec:org028da81}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org7947416}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:org79261c0}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org912f4a0}
\begin{frame}[label={sec:org0a2d7aa}]{Papers}
