...
\label{sec:org0383099}
\section{Contract languages}
\label{sec:org8f2fd65}
\begin{frame}[fragile,label={sec:org851b5cb}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org564ebeb}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgece2057}
\begin{frame}[label={sec:orgef8b40f}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org0fb050b}]{Certified symbolic management}
...
\label{sec:org1766207}
\section{Type systems}
\label{sec:org1cd7275}
\begin{frame}[label={sec:org937afa3}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orgf4bb7a1}]{Certified symbolic management}
...
\begin{frame}[label={sec:orgdbc5543}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org4fe496d}]{Functional reactive programs}
\begin{itemize}
...
Types are \alert{indexed} over time\footnote{we use \(\univ{i}\) to represent the universe of types \(i\).}: $$RSet = Time \rightarrow \univ{0}, ~~ RSet \in \univ{1}$$
\end{itemize}
...
\begin{frame}[label={sec:org3d35efb}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orga7a1036}
\begin{frame}[label={sec:org928128a}]{Papers}
