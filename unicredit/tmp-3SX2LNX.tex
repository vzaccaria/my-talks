...
\label{sec:orgb4c2876}
\section{Contract languages}
\label{sec:org7852747}
\begin{frame}[fragile,label={sec:org6a0d149}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgae4437e}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orga05061a}
\begin{frame}[label={sec:orga43ffff}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgfe075c8}]{Certified symbolic management}
...
\label{sec:org19bd097}
\section{Type systems}
\label{sec:orga7bed20}
\begin{frame}[label={sec:org636027a}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org456100b}]{Certified symbolic management}
...
\section{References}
\label{sec:org9e18ae1}
\begin{frame}[label={sec:org9fdc17d}]{Papers}
