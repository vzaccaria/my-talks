...
\label{sec:org86f5935}
\section{Contract languages}
\label{sec:orgb8fdf3f}
\begin{frame}[fragile,label={sec:org72f7d8b}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf49ccbb}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:orgd367002}
\begin{frame}[label={sec:orgb7a98c0}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org9d7365c}]{Certified symbolic management}
...
\label{sec:org86824d3}
\section{Type systems}
\label{sec:org1929b92}
\begin{frame}[label={sec:orge813831}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orga4e343a}]{Certified symbolic management}
...
\begin{frame}[label={sec:org2ce8d2a}]{Functonal Reactive programs and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org3ef898f}
\begin{frame}[label={sec:org32e5793}]{Papers}
