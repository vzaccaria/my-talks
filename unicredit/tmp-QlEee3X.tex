...
\label{sec:orge22f931}
\section{Contract languages}
\label{sec:orgaaedaf4}
\begin{frame}[fragile,label={sec:org8bdb7fa}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org9d7bd1e}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org96ca854}
\begin{frame}[label={sec:orgdddb749}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org15ac1fd}]{Certified symbolic management}
...
\label{sec:org33da8a6}
\section{Type systems}
\label{sec:org0c7bd7b}
\begin{frame}[label={sec:orga7fb17e}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org916470a}]{Certified symbolic management}
...
\begin{frame}[label={sec:orgff310c2}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org4a10c92}]{Functional reactive programs}
\begin{itemize}
...
Types are \alert{indexed} over time: $$RSet = Time \rightarrow \univ{0}, ~~ RSet \in \univ{1}$$\footnote{we use \(\univ{i}\) to represent the universe of types \(i\).}
\end{itemize}


\begin{itemize}
\item One of the inhabitant of \(RSet\) is the function \(Past\):
\end{itemize}
\end{frame}
...
\begin{frame}[label={sec:org15d191c}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org2d6cd41}
\begin{frame}[label={sec:org7489a87}]{Papers}
