...
\label{sec:org692bcec}
\section{Contract languages}
\label{sec:org959712d}
\begin{frame}[fragile,label={sec:org6640c11}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org1a7b1d6}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org61ebcbb}
\begin{frame}[label={sec:org38c2470}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgf3ce087}]{Certified symbolic management}
...
\label{sec:org00437fa}
\section{Type systems}
\label{sec:org29c04ef}
\begin{frame}[label={sec:org23032c1}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orgc613697}]{Certified symbolic management}
...
\begin{frame}[label={sec:org9685f14}]{Functional Reactive programs}
...
\begin{frame}[label={sec:orgab58d4a}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:orgf7a5b71}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgd8438a2}
\begin{frame}[label={sec:org4cdcedd}]{Papers}
