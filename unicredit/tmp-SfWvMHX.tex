...
\label{sec:org5af38f7}
\section{Contract languages}
\label{sec:org3e39c5e}
\begin{frame}[fragile,label={sec:org5015df4}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org44b5cb2}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times; sintax similar to others
\end{itemize}
\end{frame}
...
\section{Semantics}
\label{sec:orgfe27675}
\begin{frame}[label={sec:orgfbae9ec}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgd6ecb21}]{Certified symbolic management}
...
\label{sec:org27adbfd}
\section{Type systems}
\label{sec:org97ab919}
\begin{frame}[label={sec:orgc6e6c94}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org70ecd33}]{Certified symbolic management}
...
\section{References}
\label{sec:org3da1609}
\begin{frame}[label={sec:org174b0b7}]{Papers}
