...
\label{sec:org7fc712e}
\section{Contract languages}
\label{sec:org03b7b2c}
\begin{frame}[fragile,label={sec:orge8b725a}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org58d676c}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org3552c59}
\begin{frame}[label={sec:org256744d}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org942c849}]{Certified symbolic management}
...
\label{sec:orgbe2ab76}
\section{Type systems}
\label{sec:org8113673}
\begin{frame}[label={sec:orgcf6d57f}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org605b37b}]{Certified symbolic management}
...
\begin{frame}[label={sec:orgee4ea0c}]{Functional Reactive programs}
...
\begin{frame}[label={sec:orga4c2b91}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:org6d06d2a}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:org1e3d86a}
\begin{frame}[label={sec:orgc197193}]{Papers}
