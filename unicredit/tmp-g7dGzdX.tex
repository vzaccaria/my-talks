...
\label{sec:org22c7028}
\section{Contract languages}
\label{sec:orgbd56ff1}
\begin{frame}[fragile,label={sec:org9f27394}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org3c502ba}]{Findel}
\end{frame}


\section{Semantics}
\label{sec:org43eb17e}
\begin{frame}[label={sec:orge8d49db}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:orgfa8e416}]{Certified symbolic management}
...
\label{sec:orgcc024e6}
\section{Type systems}
\label{sec:org9315147}
\begin{frame}[label={sec:orgceadb00}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:org877cadd}]{Certified symbolic management}
...
\section{References}
\label{sec:orgea0869e}
\begin{frame}[label={sec:org8192c5b}]{Papers}
