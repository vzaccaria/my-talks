...
\label{sec:org596b016}
\section{Contract languages}
\label{sec:org05a8da0}
\begin{frame}[fragile,label={sec:orgdcd1fa2}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:org4182541}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org5726555}
\begin{frame}[label={sec:org9311449}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org68a4fb0}]{Certified symbolic management}
...
\label{sec:org738ecfa}
\section{Type systems}
\label{sec:orga0b2fc0}
\begin{frame}[label={sec:orgd3a0d26}]{Certified symbolic management}
\begin{itemize}
...
\begin{frame}[label={sec:orgecf253f}]{Certified symbolic management}
...
\begin{frame}[label={sec:org535b89c}]{Functional Reactive programs}
...
\begin{frame}[label={sec:org4487969}]{Functional reactive programs}
\begin{itemize}
...
\begin{frame}[label={sec:orgb040116}]{and temporal logic cite:Pnueli:1977wy}
...
\section{References}
\label{sec:orgc095910}
\begin{frame}[label={sec:org4304739}]{Papers}
