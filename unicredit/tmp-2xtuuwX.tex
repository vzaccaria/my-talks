...
\label{sec:org563ce29}
\section{Contract languages}
\label{sec:orgdab4c3e}
\begin{frame}[fragile,label={sec:orgff3cec9}]{Certified symbolic management cite:Bahr:2015hm}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf4035b9}]{Findel cite:Biryukov:2017ip}
\begin{itemize}
\item Absolute times;
...
\section{Semantics}
\label{sec:org0964ce0}
\begin{frame}[label={sec:orgbb8ab4b}]{Certified symbolic management cite:Bahr:2015hm}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org36adc99}]{Certified symbolic management}
